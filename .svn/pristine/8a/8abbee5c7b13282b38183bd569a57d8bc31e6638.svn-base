...
System.out.println(span3.getClass().getName());
//SimpleDateFormat formater = new SimpleDateFormat("EEE MMM dd HH:mm:ss z yyyy", new Locale("en", "US"));
SimpleDateFormat formater = new SimpleDateFormat("EEE MMM dd HH:mm:ss z yyyy", Locale.ENGLISH);
Date date = formater.parse(span3);
        ...
        <div class="main-content">
            <div class="container">
                ...
                <form id="frm01" action="${path}/draw.do" class="form"  method="post">
                    ...
                    <p style="font-size:12px; text-align: center; margin-top: 20%; color:#bfbfbf">당첨자 발표일은 <fmt:formatDate value="<%=date%>" pattern="yyyy-MM-dd"/> 입니다.</p>
                    <div class="button1">
