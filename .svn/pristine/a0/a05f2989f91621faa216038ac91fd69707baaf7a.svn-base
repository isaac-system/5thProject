    ...
    <div class="wrapper">
        ...
        <div align="center">
			<table>
       		...
       		<td colspan="2"><input type="checkbox" name="standard1" id="standard2" value="중급">중급</td>
       		<td colspan="2"><input type="checkbox" name="standard2" id="standard3" value="고급">고급</td>
			</tr>
       		
       		<tr><th>넥</th><td colspan="2"><input type="checkbox" name="neck"  value="로즈우드">로즈우드</td>
       		<td colspan="2"><input type="checkbox" name="neck1"  value="메이플">메이플</td>
       		<td colspan="2"><input type="checkbox" name="neck2"  value="인디안로렐">인디안로렐</td></tr>
       		
       		<tr><th>브랜드</th><td><input type="checkbox" name="brand"  value="깁슨">깁슨</td>
       		<td><input type="checkbox" name="brand1"  value="펜더">펜더</td>
       		<td><input type="checkbox" name="brand2"  value="스털링">스털링</td>
       		<td><input type="checkbox" name="brand3"  value="에피폰">에피폰</td>
       		<td><input type="checkbox" name="brand4"  value="스콰이어">스콰이어</td>
       		<td><input type="checkbox" name="brand5"  value="바커스">바커스</td></tr>
